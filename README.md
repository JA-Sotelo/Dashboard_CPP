...
> `logo 4.jpg` está embebido en base64 dentro de `index.html` — no hace falta incluirlo en el repositorio.
...
- **"Limpiar filtros"** en los segmentadores resetea también todos los cross-filters
